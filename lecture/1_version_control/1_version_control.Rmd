...
xaringan_to_pdf(
  input = "1_version_control.html",
  output_file = "1_version_control.pdf")
```
...
- Linking issues to branches is the better approach when you are already documenting the scope of a feature branch in issues and use GitHub projects to manage your repsository
]
.pull-right[
```{r out.width = "100%", fig.align='center', echo=FALSE}
