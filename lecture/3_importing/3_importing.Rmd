...
xaringan_to_pdf(
  input = "3_importing.html",
  output_file = "3_importing.pdf")
```
...
If `FALSE`, the default, the existing will be overwritten. If `TRUE`, it will be appended to the existing file.
]
