...
- Observations may be correlated within groups (clusters) but independent across groups
...
- The `fixest` package offers a fast implementation of fixed effects estimators, covering a wide range of (micro-)econometric applications
...
```{r ref.label="summary_table", echo=FALSE, warning=FALSE, eval=FALSE}
```
