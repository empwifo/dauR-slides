...
xaringan_to_pdf(
  input = "_introduction.html",
  output_file = "_introduction.pdf"
)
```
...
.right[... conduct empirical projects on your own]
...
.right[... use GitHub for version control of your code and collaboration]

--

.right[... create dynamic, technical reports using Quarto]
...
- Working on an own data analysis project
  ...
  - In groups of up to **TBD** students
...
- Registration via Flexnow required!
  ...
  - Registration period: **TBD** to **TBD**
  
  - *Note:* Registration has to be done before the group work starts

- If you have questions: [sven.werenbeck-ueding@ruhr-uni-bochum.de](mailto:sven.werenbeck-ueding@ruhr-uni-bochum.de)
